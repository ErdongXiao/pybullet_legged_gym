...
from gym_env import AliengoGymEnv

title = 'PyBullet Aliengo robot'

def get_args():
    parser = argparse.ArgumentParser(description=title)
    arg = parser.add_argument
    # env
    # arg('--env_name', type=str, default='AliengoGymEnv', help='environment name')
    ...
    arg('--repeat', type=int, default=9, help='repeat action')
    ...
    arg('--lr', type=float, default=5e-4, help='parameters for Adam optimizer')
    ...
    arg('--loss_value_c', type=float, default=1.0, help='coefficient for value term in loss')
