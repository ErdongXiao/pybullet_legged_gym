...
def get_args():
    ...
    arg('--repeat', type=int, default=18, help='repeat action')
...
print(title)
args.env_name = title
env = AliengoGymEnv(renders=args.render, maxSteps=args.mel, 
...
state_dict = torch.load(args.trained_file)["model_state_dict"]
del state_dict["std"]
