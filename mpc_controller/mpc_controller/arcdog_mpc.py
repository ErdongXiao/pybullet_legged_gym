...
from mpc_controller import arcdog_sim as robot_sim
...
def _generate_example_linear_angular_speed(t):
  ...
  vx = 1.2 * robot_sim.MPC_VELOCITY_MULTIPLIER
...
def _run_example(max_time=_MAX_TIME_SECONDS):
  ...
  # print(robot_sim.URDF_NAME)
  robot_uid = p.loadURDF(robot_sim.URDF_NAME, robot_sim.START_POS,useFixedBase=0)
